                      ...
                      if(data.type === 0){
                          if ($('body .section__content').length > 0) {
                              ...
                              $(".section__content .content-box").eq(0).after("<div class='content-box'>\n" +
                                  ...
                                  "                <p class='Custom-message-desp'>Please <p id='pdf_button' style='border: #0056b3 1px solid;cursor: pointer;color: #0056b3' data-order='"+ shopifyorderid +"' data-url='https://postdelay.shopifyapplications.com/download/pdf'>  Print out this form</p> and include it in your shipment to us </p>\n" +
