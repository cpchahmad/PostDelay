...
<div style="max-width: 767px;margin: auto;overflow: hidden;font-size: 0;padding: 25px;">
    <div class="content_area" style="width: 70%;display: inline-block;font-size: 16px;padding: 0 2.5%;">
        ...
        <div class="email_content" style="font-size: 16px;line-height: 25px;font-family: Arial;">
            ...
            <p>Send your item, including this label to: <br> PostDelay LLC <br>Box 3492  Church Street Station <br>New York, NY, 10008, USA</p>
            <p>Order :  {{$order->order_name}} <br>Order Date : {{date_create($order->created_at)->format('M d, Y')}} <br>Mail Out Date : {{date_create($order->ship_out_date)->format('M d, Y')}}  </p>
