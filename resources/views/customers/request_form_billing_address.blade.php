...
<div class="Get-name">
    <div class="custom_fields_half">
        <div class="custom_Request_fields_half  Get-name-left">
            ...
            <input type="text" @if(in_array($response,[9])) readonly=""  @endif required="" name="first_name" id="FirstName" value="{{$address->first_name}}" placeholder="">
        </div>
    </div>
    <div class="custom_fields_half">
        <div class="custom_Request_fields_half Get-name-right">
            <label for="LastName">Last Name</label>
            <input type="text" @if(in_array($response,[9])) readonly=""  @endif required="" name="last_name" id="LastName" value="{{$address->last_name}}" placeholder="">
        </div>
    </div>
</div>
<div class="custom_fields_half full_width_iput">
    <div class="custom_Request_fields_half">
        ...
        <input type="text" id="autocomplete" class="autocomplete" @if(in_array($response,[9])) readonly=""  @endif required="" name="address1"  value="{{$address->address1}}" placeholder="">
        <input type="hidden" value="{{$address->address2}}" placeholder="">
        <input type="text"  name="address2" id="Address2" @if(in_array($response,[9])) readonly=""  @endif value="{{$address->address2}}" placeholder="">
    </div>
</div>
<div class="Complete-address">
    <div id="city_div" class="custom_fields_third">
        <div class="custom_Request_fields_half">
            ...
            <input type="text" required="" @if(in_array($response,[9])) readonly=""  @endif name="city" id="City" value="{{$address->city}}" placeholder="">
        </div>
    </div>
    ...
    <div id="province_div" class="custom_fields_third ">
        <div class="custom_Request_fields_half adj">
            ...
            <input type="text"  name="state" @if(in_array($response,[9])) readonly=""  @endif id="administrative_area_level_1" value="{{$address->state}}" placeholder="">
        </div>
    </div>
    ...
    <div id="postal_div" class="custom_fields_third">
        <div class="custom_Request_fields_half">
            ...
            <input type="text" required="" @if(in_array($response,[9])) readonly=""  @endif name="postcode" id="PosteCode" value="{{$address->postcode}}" placeholder="">
        </div>
    </div>
</div>
